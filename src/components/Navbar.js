        ...
        <nav className="shadow-md p-5">
            <div className="flex justify-between item-center mb-2">
                ...
                <div className="space-x-6">
                    <Link to="/" className="text-black hover:text-gray-400">Top Up</Link>
                    <Link to="/" className="text-black hover:text-gray-400">Transaction</Link>
                    <Link to="/" className="text-black hover:text-gray-400">Akun</Link>
                </div>
